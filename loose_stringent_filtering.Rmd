...
I am taking the taxonomy file generated from taxonomizr_blast_tidied_2025.Rmd and starting with that file for all subsequent work:
...
```{r}
load("merged_with_taxa_2025") #originally created and saved in the R notebook that preceeds this one, "taxonomizr_blast_tidied_2025.Rmd"
```

Loose filtering:

```{r}
loose_ext_exp_2025 <- merged_with_taxa_2025 %>%
...
```{r}
stringent_ext_exp_2025 <- merged_with_taxa_2025  %>%
