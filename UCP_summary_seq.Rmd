...
```{r}
sequencing_summary <- read_delim ("C:/Users/keegk/OneDrive - moredungroup/Karen Keegan/Nanopore/SQKRBK004/Extraction_experiment_run_22.2.23/Rebasecalling/Rebasecalled_trimmed_super_accuracy/barcode_5/sequencing_summary_barcode5.txt")


extexp2025_barcode5_remove_reads <- sequencing_summary %>%
...
extexp2025_barcode5_remove_reads <- save(extexp2025_barcode5_remove_reads, file = "extexp2025_barcode5_remove_reads")
load("extexp2025_barcode5_remove_reads") #this was saved with 2025 written after it but the actual file name loads in without the 2025 bit after it just FYI.
