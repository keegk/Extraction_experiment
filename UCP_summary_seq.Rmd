...
```{r}
sequencing_summary <- read_delim ("C:/Users/keegk/OneDrive - moredungroup/Karen Keegan/Nanopore/SQKRBK004/Extraction_experiment_run_22.2.23/Rebasecalling/Rebasecalled_trimmed_super_accuracy/barcode_5/sequencing_summary_barcode4.txt")

sequencing_summary <- sequencing_summary %>%
                      filter(barcode_full_arrangement == "RBK405") #making sure only the correct barcode is included
```
