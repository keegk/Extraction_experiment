...
```{r}
merged_with_taxa_2025 <- left_join(x = combined_blast_sorted, y = taxa_table_distinct, by ="subject.tax.ids") 
#combined_blast[2644, ]
#taxa1[2644, ]
...
merged_with_taxa_2025 <- save(merged_with_taxa_2025, file = "merged_with_taxa_2025")
load("merged_with_taxa_2025") #this was saved with 2025 written after it but the actual file name loads in without the 2025 bit after it just FYI.
