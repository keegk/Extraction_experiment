...
extexp2025_barcode6_remove_reads <- sequencing_summary %>%
...
extexp2025_barcode6_remove_reads <- save(extexp2025_barcode6_remove_reads, file = "extexp2025_barcode6_remove_reads")
load("extexp2025_barcode6_remove_reads") #this was saved with 2025 written after it but the actual file name loads in without the 2025 bit after it just FYI.
